...
class m140724_210946_create_issue_user_and_assignment_tables extends CDbMigration
{
	/*
	public function up()
	{
	...
	{
		echo "m140724_210946_create_issue_user_and_assignment_tables does not support migration down.\n";
		return false;
	}
	*/
	...
	public function safeUp()
	{
		...
		$this->addForeignKey("fk_user_project", "tbl_project_user_assignment", "user_id", 
			"tbl_user", "id", "CASCADE", "RESTRICT");
	}
